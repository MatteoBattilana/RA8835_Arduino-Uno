...
This example uses a LM7805 as voltage regulator, in order to get 5V form a commong ground. This circuit needs +24V and -24V voltages connected to the corresponding labels on the voltage lines in the right part of the breadboard.
